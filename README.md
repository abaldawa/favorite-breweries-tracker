...
- Beer page ~ style a cool beer page (Mandatory) - **COMPLETED**
- Home page favourites ~ add a list of favourite beers, do not clean after page reload (Mandatory) - **COMPLETED**
- Beer list filtering + pagination + sorting (Mandatory) - **COMPLETED**
- Progressive Web App, offline (Non Mandatory) - **NOT DONE**
